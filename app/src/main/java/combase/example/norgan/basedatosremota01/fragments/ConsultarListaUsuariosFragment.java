...
public class ConsultarListaUsuariosFragment extends Fragment implements Response.Listener<JSONObject>,Response.ErrorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerLista = (RecyclerView)vista.findViewById(R.id.recyclerLista);
        recyclerLista.setLayoutManager(new LinearLayoutManager(this.getContext()));
    ...
    private void cargawebservices() {
        ...
        String url = "http://192.168.1.41/BDRemota/wsJSONConsultarLista.php";
